...
const BroadcastModal = ({
  ...
  const selectedGroup = useSelector(
    (state: RootState) => state.groupSlice.selectedGroup
  );
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        ...
        <Typography
          sx={{ color: "#fff", fontSize: 14, mb: 1, fontWeight: 500 }}
        >
          Select an Agent
        </Typography>
          ...
          <Select
            ...
            onChange={(e) => {
              ...
              const agentObj = agents.find(
                (elem) => elem.agent_name === e.target.value
              );
            ...
            renderValue={(selected) =>
              selected ? (
                ...
                <span style={{ color: "#b0b0b5" }}>Select Agent</span>
              )
            }
          >
